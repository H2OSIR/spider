# -*- coding:utf-8 -*-
"""some object you need, when you want to request url."""

import random

# categories of http connection exception
_HTTP_Status_Code = {
...
# random user_agent
random_userAgent = _User_Agent_List[random.randrange(0, len(_User_Agent_List))]
